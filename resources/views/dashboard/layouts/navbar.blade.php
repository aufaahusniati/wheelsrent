    ...
    <div class=" py-4  px-6 flex items-center justify-between border-b relative">
        ...
        <div id="dropdownHover"
            ...
            <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownHoverButton">
                ...
                <li>
                    <a href="/"
                        class="px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white flex">
                    ...
                    <a href="#"
                        ...
                        <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                            ...
                            <path
                                d="M7.324 9.917A2.479 2.479 0 0 1 7.99 7.7l.71-.71a2.484 2.484 0 0 1 2.222-.688 4.538 4.538 0 1 0-3.6 3.615h.002ZM7.99 18.3a2.5 2.5 0 0 1-.6-2.564A2.5 2.5 0 0 1 6
                    ...
                    <form action="/logout" method="post">
                        ...
                        <button type="submit" class="px-4 py-2 hover:bg-gray-100 flex">
                            <svg class="w-5 h-5 mt-1 text-gray-800 dark:text-white" aria-hidden="true"
