...
<div class="bg-primary bg-opacity-30 mx-24 mb-3 rounded-xl">
  <div class="flex items-center justify-between py-10 mt-7 px-10">
      ...
      <a href="/dashboard/posts" >
        ...
        focus:ring-red-400 rounded-lg text-md px-14 py-2.5 mt-5 text-center me-2 mb-2 "> < Back
      </button>
      </a>
    </div>
    ...
    <div class="flex flex-wrap items-center">
      <form method="post" action="/dashboard/posts" class="pl-72 mx-28" enctype="multipart/form-data">
          ...
          <div class="mb-4 ">
            ...
            <input type="text" class="form-control ml-[93px] rounded-lg" placeholder="Honda"
          ...
          <div class="mb-4 ">
            ...
            <input type="text" class="form-control ml-[89px] rounded-lg" placeholder="civic"
            id="title" name="title" required autofocus value="">
            @error('title')
                  <div class="invalid-feedback">
                    {{ $message}}
          ...
          <div class="mb-3">
            ...
            <div class="mb-4 ">
              ...
              <input type="text" class="form-control ml-28 rounded-lg" placeholder="Disel.."
              id="title" name="title" required autofocus value="">
              @error('title')
                    <div class="invalid-feedback">
                      {{ $message}}
            ...
            <div class="mb-4 ">
              ...
              <input type="text" class="form-control ml-[103px] rounded-lg" placeholder="Rp. ..."
              id="title" name="title" required autofocus value="">
              @error('title')
                    <div class="invalid-feedback">
                      {{ $message}}
         ...
         focus:ring-blue-300 rounded-lg text-md px-5 py-2.5 text-center me-2 mb-2 ">+ Create New Data
        </button>
                </a>
              </div>
            {{-- End Button --}}
