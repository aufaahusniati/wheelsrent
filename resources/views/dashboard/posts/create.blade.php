    ...
    <div class="bg-primary bg-opacity-30 mx-24 mb-3 rounded-xl">
        <div class="flex items-center justify-between py-10 mt-7 px-10">
            ...
            <a href="/dashboard/posts">
                <button type="submit"
                    class="font-semibold hover:text-white border border-red-600 bg-red-500 hover:bg-red-700 focus:ring-4 focus:outline-none
        focus:ring-red-400 rounded-lg text-md px-14 py-2.5 mt-5 text-center me-2 mb-2 ">
                    < Back </button>
            </a>
        </div>
        ...
        <div class="flex flex-wrap items-center">
         ...
         focus:ring-blue-300 rounded-lg text-md px-5 py-2.5 text-center me-2 mb-2 ">+
                            Create New Data
                        </button>
                    </a>
                </div>
