...
<div class="bg-primary h-auto bg-opacity-30 mx-24 mt-14 rounded-xl ">
    ...
    <div class="flex flex-wrap justify-between">
        <a href="/dashboard/posts/create">
            <button type="submit" class="font-semibold text-white bg-green-500 border-2 border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none 
             focus:ring-blue-300 rounded-lg text-md px-5 ml-24 py-2.5 text-center me-2 mb-5 ">+ Create New Data
            </button>
        </a>
        ...
        <div class="flex flex-wrap justify-end pr-24 ">
            ...
            <!-- Dropdown menu -->
                <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    ...
                    <li>
                        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Recent</a>
                    </li>
                    <li>
    ...
    <div class="relative px-24 overflow-x-auto pb-10">
        ...
        <table class="w-full text-lg text-center rtl:text-right rounded-lg text-black dark:text-white border-x-2 border-y-2 border-black">
                            ...
                            {{-- icon show --}}
                             <div class=" inline-flex">
                                <a href="/dashboard/posts/show" >
                                    <svg class="w-7 h-7 text-green-600 mr-3 hover:text-green-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 14">
                                ...
                                {{-- <a href="/dashboard/posts/edit" >
                                    <svg class="w-7 h-7 text-yellow-300 hover:text-yellow-600 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                ...
                                {{--ion hapus  --}}
                                <a href="#" >
                                    <svg class="w-6 h-6 text-red-500 hover:text-red-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
