...
<div class="bg-primary bg-opacity-30 mx-24 mb-3 mt-10 rounded-xl">
    <div class="flex items-center justify-between ">
        <h1 class=" py-5 px-10 text-5xl font-semibold">Cars Make</h1>
    </div>
    <div class="flex flex-wrap justify-between pr-20 pb-4">
        <a href="/dashboard/make/create">
            ...
            focus:ring-blue-300 rounded-lg text-md px-5 ml-24 py-2.5 text-center me-2">+
                Create New Data
            </button>
        </a> 
        {{-- search --}}
    ...
    <div class="relative px-24 overflow-x-auto flex flex-wrap justify-center pb-5 ">
        <table class="w-full text-lg text-center rtl:text-right text-black border-x-2 border-y-2 border-black">
            ...
            {{-- Isi table --}}
            <tbody>
                <tr class="odd:bg-white text-center text-sm">
                    ...
                    <td class=" px-2 py-4 border-black border-y-2">
                        ...
                        <div class=" inline-flex">
                            ...
                            {{-- icon Edit  --}}
                            <a href="#">
                                <svg class="w-6 h-6 mx-4" xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512">
                                    <path fill="#fbff0a" d="M410.3 231l11.3-11.3-33.9-33.9-62.1-62.1L291.7 89.8l-11.3 11.3-22.6 22.6L58.6 322.9c-10.4 10.4-18 23.3-22.2 37.4L1 480.7c-2.5 8.4-.2 17.5 6.1 23.7s15.3 8.5 23.7 6.1l120.3-35.4c14.1-4.2 27-11.8 37.4-22.2L387.7 253.7 410.3 231zM160 399.4l-9.1 22.7c-4 3.1-8.5 5.4-13.3 6.9L59.4 452l23-78.1c1.4-4.9 3.8-9.4 6.9-13.3l22.7-9.1v32c0 8.8 7.2 16 16 16h32zM362.7 18.7L348.3 33.2 325.7 55.8 314.3 67.1l33.9 33.9 62.1 62.1 33.9 33.9 11.3-11.3 22.6-22.6 14.5-14.5c25-25 25-65.5 0-90.5L453.3 18.7c-25-25-65.5-25-90.5 0zm-47.4 168l-144 144c-6.2 6.2-16.4 6.2-22.6 0s-6.2-16.4 0-22.6l144-144c6.2-6.2 16.4-6.2 22.6 0s6.2 16.4 0 22.6z"/>
                                </svg>
                            </a>
                            {{-- end icon Edit  --}}
                            ...
                            {{-- icon hapus  --}}
                            <a href="#">
                                <svg class="w-6 h-6 ml-2 text-red-500 hover:text-red-800" aria-hidden="true"
