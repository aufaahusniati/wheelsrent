    ...
    <div class="bg-primary h-auto bg-opacity-20 mt-14 rounded-xl ">
        ...
        <div class="flex flex-wrap justify-between">
            <a href="/dashboard/car/create">
                <button type="submit" class="font-semibold text-white bg-green-500 border-2 hover:bg-green-800 rounded-lg text-sm px-2 ml-24 py-2 text-center me-2 mb-5 ">
                    + Create New Data
                </button>
            </a>
            ...
            <div class="flex flex-wrap justify-end">
                ...
                {{-- Sort by --}}
                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-2 mx-3 mb-6 text-center inline-flex items-center" type="button">
                    Sort by
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <label for="checkbox-item-1"
                                    class="ms-2 text-sm font-medium text-gray-900">Make</label>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                                ...
                                <label for="checkbox-item-2"
                                    class="ms-2 text-sm font-medium text-gray-900">Model</label>
                            </div>
                        </li>
                    </ul>
                </div>
