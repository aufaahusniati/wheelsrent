            ...
            <div class="bg-white mx-5 my-5 rounded-xl -mt-6">
                ...
                <div class=" flex flex-wrap justify-start">
                    <a href="/dashboard/car/{{ $car->id }}/edit">
                        <button
                            class="text-white bg-amber-400 font-semibold hover:bg-amber-500  ml-5   px-4 py-2 text-sm mb-5 rounded-md flex justify-between items-center">
                    ...
                    <a href="/dashboard/car/{{ $car->id }}/pdf">
                        <button
                            class=" bg-blue-700 text-white font-semibold hover:bg-blue-500 hover:bg-opacity-100  mx-2 px-4 py-2 text-sm rounded-md flex justify-between items-center">
                    ...
                    <a href="/dashboard/car">
                        <button
                            class="text-white border font-bold bg-red-500 hover:bg-red-700  px-4 py-2 text-sm rounded-md flex justify-between items-center">
                            <svg class="w-4 h-4 mr-2 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 14 10">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
