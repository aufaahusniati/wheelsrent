                ...
                <div class="p-6 bg-primary rounded-lg shadow">
                    ...
                    <div class="lg:grid lg:grid-cols-2 gap-2">
                        <form class="mb-5">
                            ...
                            <select id="make" class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                <option value="" disabled selected hidden>Select Make</option>
                                <option>Honda</option>
                            </select>
                        </form>
                        <form class="mb-5">
                            <label for="make" class="block mb-2 text-sm font-bold text-white">MODEL</label>
                            <select id="make" class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                        ...
                        <div class="relative mb-5 lg:max-w-sm">  
                            ...
                            <label for="make" class="block mb-2 text-sm font-bold text-white">START DATE</label>
                            <input datepicker type="text" class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                        </div>
                        <div class="relative mb-5 lg:max-w-sm">  
                            <div class="absolute inset-y-12 start-0 flex items-center ps-3.5 pointer-events-none">
                              <svg class="w-4 h-4 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <label for="make" class="block mb-2 text-sm font-bold text-white">END DATE</label>
                            <input datepicker type="text" class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                        </div>
                    </div>
