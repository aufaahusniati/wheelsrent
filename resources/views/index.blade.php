...
<div class="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2 bg-white dark:bg-gray-800">
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e dark:bg-gray-800 dark:border-gray-700">
        <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Sangat mudah untuk memesan mobil</h3>
            <p class="my-4">Jika Anda peduli dengan waktu Anda, saya akan setuju dengan ini."</p>
        </blockquote>
        <figcaption class="flex items-center justify-center ">
            <img class="rounded-full w-9 h-9" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/karen-nelson.png" alt="profile picture">
            <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                <div>Aufa ketua kelompok</div>
                <div class="text-sm text-gray-500 dark:text-gray-400 ">Pengembang di website kami</div>
            </div>
        </figcaption>
    </figure>
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 md:rounded-se-lg dark:bg-gray-800 dark:border-gray-700">
        <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Sangat mudah di pesan dari mana saja </h3>
            <p class="my-4">Mobil yang kita pilih sangat berkelas dan terbaru"</p>
        </blockquote>
        <figcaption class="flex items-center justify-center ">
            ...
            <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                <div>Indri </div>
                <div class="text-sm text-gray-500 dark:text-gray-400">Desain utama di alamat website kami</div>
            </div>
        </figcaption>
    </figure>
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 md:rounded-es-lg md:border-b-0 md:border-e dark:bg-gray-800 dark:border-gray-700">
        <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Alur kerja yang menakjubkan</h3>
            <p class="my-4">Secara estetika, komponen yang dirancang dengan baik akan terlihat indah dan pasti akan meningkatkan level aplikasi Anda berikutnya.”</p>
        </blockquote>
        <figcaption class="flex items-center justify-center ">
            ...
            <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                <div>Wildan</div>
                <div class="text-sm text-gray-500 dark:text-gray-400">Software Engineer di website kami</div>
            </div>
        </figcaption>
    </figure>
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-gray-200 rounded-b-lg md:rounded-se-lg dark:bg-gray-800 dark:border-gray-700">
        <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Kolaborasi yang Efisien</h3>
            <p class="my-4">Anda memiliki banyak contoh yang dapat digunakan untuk membuat prototipe cepat untuk tim Anda.”</p>
        </blockquote>
        <figcaption class="flex items-center justify-center ">
            ...
            <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                <div>Daffa</div>
                <div class="text-sm text-gray-500 dark:text-gray-400">CEO</div>
            </div>
        </figcaption>
    </figure>
</div>
