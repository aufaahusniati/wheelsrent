...
@section('container')
    <!-- Hero Section Start -->
    <section id="home" class="bg-center bg-no-repeat bg-blend-multiply bg-cover"
        style="background-image: url('/img/hero.png')">
        <div class="lg:grid lg:grid-cols-2 lg:gap-2">
            <div class="px-4 text-left ml-10 py-40 lg:py-[232px] ">
                <h1 class="mb-3 text-xl font-black tracking-tight leading-none text-dark md:text-xl lg:text-6xl">Get Your
                    Best</h1>
                <h1 class="mb-4 text-xl font-black tracking-tight leading-none text-dark md:text-xl lg:text-6xl">Experience
                    with</h1>
                <h1 class="mb-4 text-xl font-black tracking-tight leading-none text-dark md:text-xl lg:text-6xl">WheelsRent
                </h1>
    ...
    <section id="card" class="pt-32 pb-20">
        <div class="container">
            ...
            <p class="text-center lg:text-sm text-[10px] lg:mb-4">Book a car when you need to drive, save greatly, and enjoy
            ...
            <div class="gap-3 lg:grid lg:grid-cols-3">
                ...
                <div class="w-full mx-auto my-5 block max-w-sm p-6 bg-white ">
                    ...
                    <h5 class="mb-2 mt-2 text-base text-center font-bold tracking-tight text-blank lg:text-xl">Open Our
                        Website</h5>
                    <div
                        class="mb-4 border-slate-300 border-t-4 w-10 flex flex-wrap items-center justify-center  text-center mx-auto">
                    </div>
                ...
                <div class="w-full mx-auto my-5 block max-w-sm p-6 bg-white ">
                    ...
                    <h5 class="mb-2 mt-2 text-base text-center font-bold tracking-tight text-blank lg:text-xl">Book a Card
                    </h5>
                    <div
                        class="mb-4 border-slate-300 border-t-4 w-10 flex flex-wrap items-center justify-center  text-center mx-auto">
                    </div>
                    <p class="text-xs text-gray-700 lg:text-sm text-center">Open section type car to see all the cars and
                        select one.</p>
                </div>
                ...
                <div class="w-full mx-auto my-5 block max-w-sm p-6 bg-white ">
                    ...
                    <h5 class="mb-2 mt-2 text-base text-center font-bold tracking-tight  text-blank lg:text-xl">Enjoy Your
                        Ride</h5>
                    <div
                        class="mb-4 border-slate-300 border-t-4 w-10 flex flex-wrap items-center justify-center  text-center mx-auto">
                    </div>
                    <p class="text-xs text-gray-700 lg:text-sm text-center">When you are next to the car, unlock it with
                        your smartphone.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <svg class="-mx-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#EEF5FF" fill-opacity="1"
                    d="M0,224L26.7,213.3C53.3,203,107,181,160,176C213.3,171,267,181,320,186.7C373.3,192,427,192,480,165.3C533.3,139,587,85,640,101.3C693.3,117,747,203,800,245.3C853.3,288,907,288,960,240C1013.3,192,1067,96,1120,96C1173.3,96,1227,192,1280,234.7C1333.3,277,1387,267,1413,261.3L1440,256L1440,320L1413.3,320C1386.7,320,1333,320,1280,320C1226.7,320,1173,320,1120,320C1066.7,320,1013,320,960,320C906.7,320,853,320,800,320C746.7,320,693,320,640,320C586.7,320,533,320,480,320C426.7,320,373,320,320,320C266.7,320,213,320,160,320C106.7,320,53,320,27,320L0,320Z">
                </path>
            </svg>
                        ...
                        <div class="border rounded-lg p-5 h-full">
                            ...
                            <div class="gap-4 lg:grid lg:grid-cols-2">
                                ...
                                <div class="flex items-center">
                                    <div
                                        class="flex items-center justify-center border border-primary rounded-lg h-[30px] w-[32px]">
                                        <svg class="w-[25px] h-[25px]" fill="#0174BE" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="mt-4 flex items-center justify-center">
                                <a href="#"
                                    class="inline-flex items-center px-2 py-1 text-sm font-medium  text-white bg-primary rounded-full border-2 border-primary hover:bg-white hover:text-primary focus:z-10 focus:ring-2 focus:ring-primary focus:text-primary">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            fetch('/fetch-news')
                ...
                .then(data => {
                    ...
                    // Example: Display the titles, descriptions, and images of the articles
                    if (data.articles && data.articles.length > 0) {
                        ...
                        data.articles.forEach(article => {
                            ...
                            // Create elements for the news article
                ...
                <div class="md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div style="margin-bottom: 3rem;">
                        ...
                        <p class="text-left text-sm font-semibold text-gray-900 lg:text-lg">
                            "I am very satisfied with quality fleet and services provided by this car rental. Comfortable
                    ...
                    <div style="margin-bottom: 3rem;">
                        <figure class="max-w-screen-md">
                            ...
                            <p class="text-left text-sm font-semibold text-gray-900 lg:text-lg">
                                "Services from car rental this is outside normal! Clean and well-maintained cars, and
                                friendly and responsive staff. Experience rent a car it's really fun here."
                            </p>
                            <figcaption class="flex items-center mt-2 space-x-3 rtl:space-x-reverse">
                                <div class="flex items-center divide-x-2 rtl:divide-x-reverse divide-gray-300">
                    ...
                    <div style="margin-bottom: 3rem;">
                        ...
                        <p class="text-left text-sm font-semibold text-gray-900 lg:text-lg">
                            "Experienced renting a car here very satisfactory. Clean and well-maintained cars at competitive
                    ...
                    <div style="margin-bottom: 3rem;">
                        ...
                        <p class="text-left text-sm font-semibold text-gray-900 lg:text-lg ">
                            "Services from rental car This outside normal! Clean and well-maintained cars, and friendly and
                            responsive staff. Experience rent car it's really fun here."
                        </p>
                        <figcaption class="flex items-center mt-2 space-x-3 rtl:space-x-reverse">
                            <div class="flex items-center divide-x-2 rtl:divide-x-reverse divide-gray-300">
