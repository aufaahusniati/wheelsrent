                    ...
                    <div class="max-w-md px-8 py-6 bg-primary bg-opacity-30 border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 lg:w-full">
                        <form class="space-y-5" action="/register" method="post">
                            ...
                            <div>
                                ...
                                <input type="password" name="password" id="password" placeholder="Password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 @error('password') invalid:border-red-500 @enderror" rr>
                                @error('password')
                                <div class="text-red-500">
                                    {{ $message }}
                                </div>
