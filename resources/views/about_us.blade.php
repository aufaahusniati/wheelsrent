...
<section class="pb-20 pt-36 w-full">
    <div class="flex-wrap items-center justify-center text-center">
        ...
        <div class="mb-4 border-orange-400 border-t-4 w-52 lg:w-96 flex flex-wrap items-center justify-center  text-center mx-auto"></div>
        <p class="text-xs mt-5 mb-7 text-dark lg:text-lg mx-4">With over 100 years of experience in Automotive and Digital we proudly work on the best imagery solution you can IMAGINE. Deep industry knowledge is a key
            driver for all we develop for our clients. Please meet some of our team members.</p>
        <div class="grid grid-cols-4 gap-4 mx-3">
            <div class="mb-2">
                <img class="h-auto max-w-full rounded-lg shadow-md shadow-gray-600" src="/img/story_rent.jpg" alt="">
                <h1 class="font-black text-4xl mb-2 mt-3">Aufaa Husniati</h1>
                <h4 class="italic-h4">Project manager</h4>
                <p>Full-stack Developer</p>
            </div>
            <div class="mb-2">
                <img class="h-auto max-w-full rounded-lg shadow-md shadow-gray-600" src="/img/story_rent.jpg" alt="">
                <h1 class="font-black text-4xl mb-2 mt-3">Widya Indrianti</h1>
                <h4 class="italic-h4">Member</h4>
                <p>Front-End Developer</p>
            </div>
            <div class="mb-2">
                <img class="h-auto max-w-full rounded-lg shadow-md shadow-gray-600" src="/img/story_rent.jpg" alt="">
                <h1 class="font-black text-4xl mb-2 mt-3">Daffa Gimnastiar</h1>
                <h4 class="italic-h4">Member</h4>
                <p>Front-End Developer</p>
            </div>
            <div class="mb-2">
                <img class="h-auto max-w-full rounded-lg shadow-md shadow-gray-600" src="/img/story_rent.jpg" alt="">
                <h1 class="font-black text-4xl mb-2 mt-3">Wildan N. Reliyanto</h1>
                <h4 class="italic-h4">Member</h4>
